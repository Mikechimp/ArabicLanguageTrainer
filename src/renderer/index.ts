...
import { GuidedReaderView } from './views/guided-reader';
...
class App {
  ...
  private registerViews(): void {
    ...
    this.router.register('guided-reader', () => new GuidedReaderView(this.api));
    this.router.register('resources', () => new ResourcesView());
